...
public class Aplication {
	...
	public static void testeCurso() {
		...
		//curso4.setNmCurso("Introducao Nova");
	...
	public static void testeProfessor() {
		...
		Professor prof11 = ctrl.buscaPorId(1);
		
		prof11.setEscolaridade(Escolaridade.GRADUACAO);
		ctrl.alterar(prof11);
	...
	public static void testePessoa() {
		...
		try {
			...
			ctrl.inserir(pes4);
			 ...
			 Pessoa pes11 = ctrl.buscaPorId(2);
			...
			pes22.setDtNascimento(simpleDateFormat.parse("01-04-2000"));
			ctrl.alterar(pes22);

			Pessoa pes33 = ctrl.buscaPorId(3);
			pes33.setDtNascimento(simpleDateFormat.parse("15-06-2005"));
			ctrl.alterar(pes33);
			
			Pessoa pes44 = ctrl.buscaPorId(4);
			pes44.setDtNascimento(simpleDateFormat.parse("30-09-2015"));
			ctrl.alterar(pes44); 
